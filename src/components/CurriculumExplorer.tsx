...
type ExtraView = "review1" | "review2" | "review3" | "poem2" | "poem1" | "poem4";
...
{extra === "review1" || extra === "review2" || extra === "review3" ? (
...
lessonContext={
            extra === "review1"
              ...
              : extra === "review2"
                ...
                : extra === "review3"
                ? "Grade 10 English — Review 3 (Units 7–9 revision)"
                : extra === "poem2"
                  ? "Grade 10 English — Poem 2: The Blind Boy (Colley Cibber)"
                  : extra === "poem4"
                    ? "Grade 10 English — Poem 4: What Is Pink? (Christina Rossetti)"
  ...
  return (
    <div className="space-y-3">
      {SYLLABUS.map((node) => {
if (node.type === "banner") {
          const reviewTarget: ExtraView | null =
            node.id === "r1"
              ? "review1"
              : node.id === "r2"
                ? "review2"
                : node.id === "r3"
                  ...
                  : node.id === "r4"
                    ? "poem4"
                    : null;
          const poemTarget: ExtraView | null =
            node.id === "r1" ? "poem1" : node.id === "r2" ? "poem2" : node.id === "r4" ? "poem4" : null;
          return (
            <div
              key={node.id}
